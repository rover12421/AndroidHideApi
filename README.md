...
``` groovy
dependencies {
    compile 'com.rover12421.AndroidHideApi:android:1.16'
}
```
...
dependencies {
    androidHideApi 'com.rover12421.AndroidHideApi:android:1.16'
    compileOnly 'com.rover12421.AndroidHideApi:android:1.16'
}

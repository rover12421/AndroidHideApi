...
//        return intent;
     ...
     */
    public abstract /*@CheckResult*/ String[] getPackagesForUid(int uid);
     ...
     */
    public abstract /*@CheckResult*/ String getNameForUid(int uid);
     ...
     *            the {@link Intent#CATEGORY_DEFAULT}.
     ...
     *            returned. The most important is {@link #MATCH_DEFAULT_ONLY},
     *            to limit the resolution to only those activities that support
     *            the {@link Intent#CATEGORY_DEFAULT}. Or, set

...
public interface IPackageInstaller extends android.os.IInterface {
    ...
    public int createSession(android.content.pm.PackageInstaller.SessionParams params, String installerPackageName, int userId) throws android.os.RemoteException;
